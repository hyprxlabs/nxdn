...
public static class IdentityEntityFrameworkBuilderExtensions
{
    ...
    public static IdentityBuilder AddHyprxEntityFrameworkStores<TContext>(this IdentityBuilder builder)
    ...
    private static void AddStores(IServiceCollection services, Type userType, Type? roleType, Type contextType)
    {
        ...
        {
            throw new InvalidOperationException("Not an IdentityUser");
        }
        ...
        if (roleType != null)
        {
            ...
            {
                throw new InvalidOperationException("Not an IdentityRole");
            }
