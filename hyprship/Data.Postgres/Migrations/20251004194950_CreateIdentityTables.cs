        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    upcase_name = table.Column<string>(type: "character varying(38)", maxLength: 38, nullable: false),
                    concurrency_stamp = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    concurrency_stamp = table.Column<string>(type: "character varying(38)", maxLength: 38, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    security_stamp = table.Column<string>(type: "character varying(38)", maxLength: 38, nullable: true),
                    concurrency_stamp = table.Column<string>(type: "character varying(38)", maxLength: 38, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    roles_id = table.Column<Guid>(type: "uuid", nullable: false),
                    user_api_keys_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
