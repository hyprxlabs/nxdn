...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RoleStore{TRole, TContext}"/> class.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RoleStore{TRole, TContext, TKey}"/> class.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public RoleStore(TContext context, IdentityErrorDescriber? describer = null)
    ...
    where TRoleClaim : IdentityRoleClaim<TKey>, new()
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RoleStore{TRole, TContext, TKey, TUserRole, TRoleClaim}"/> class.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public RoleStore(TContext context, IdentityErrorDescriber? describer = null)
    ...
    /// <summary>
    /// Gets the navigation property for the roles the store contains.
    /// </summary>
    public virtual IQueryable<TRole> Roles => this.Context.Set<TRole>();

    private DbSet<TRoleClaim> RoleClaims => this.Context.Set<TRoleClaim>();
    ...
    public virtual Task<TRole?> FindByIdAsync(string id, CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        return this.Roles.FirstOrDefaultAsync(u => u.Id.Equals(roleId), cancellationToken);
    }
    ...
    public virtual Task<TRole?> FindByNameAsync(string normalizedName, CancellationToken cancellationToken = default(CancellationToken))
    {
        cancellationToken.ThrowIfCancellationRequested();
        this.ThrowIfDisposed();
        return this.Roles.FirstOrDefaultAsync(r => r.Name == normalizedName, cancellationToken);
    }
    ...
    public virtual async Task RemoveClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken = default(CancellationToken))
    {
        ...
        ArgumentNullException.ThrowIfNull(role);
        ArgumentNullException.ThrowIfNull(claim);
        var claims = await this.RoleClaims
