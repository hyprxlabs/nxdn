...
public class IdentityDbContext<TUser, TRole, TKey> :
    IdentityDbContext<TUser, TRole, TKey, IdentityUserClaim<TKey>, IdentityUserPasswordAuth<TKey>, IdentityUserRole<TKey>, IdentityUserLoginProvider<TKey>, IdentityRoleClaim<TKey>, IdentityUserToken<TKey>>
    where TUser : IdentityUser<TKey>
    where TRole : IdentityRole<TKey>
    where TKey : IEquatable<TKey>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IdentityDbContext{TUser, TRole, TKey}"/> class.
    /// </summary>
    /// <param name="options">The options to be used by a <see cref="DbContext"/>.</param>
    public IdentityDbContext(DbContextOptions options)
        : base(options)
...
public class IdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserPasswordAuth, TUserRole, TUserLogin, TRoleClaim, TUserToken> :
    IdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserPasswordAuth, TUserRole, TUserLogin, TRoleClaim, TUserToken, IdentityUserPasskey<TKey>>
    where TUser : IdentityUser<TKey>
    where TRole : IdentityRole<TKey>
    where TKey : IEquatable<TKey>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IdentityDbContext{TUser, TRole, TKey, TUserClaim, TUserPasswordAuth, TUserRole, TUserLogin, TRoleClaim, TUserToken}"/> class.
    /// </summary>
    /// <param name="options">The options to be used by a <see cref="DbContext"/>.</param>
    public IdentityDbContext(DbContextOptions options)
        : base(options)
...
public abstract class IdentityDbContext<TUser, TRole, TKey, TUserClaim, TUserPasswordAuth, TUserRole, TUserLogin, TRoleClaim, TUserToken, TUserPasskey> :
    IdentityUserContext<TUser, TKey, TUserClaim, TUserPasswordAuth, TUserLogin, TUserToken, TUserPasskey>
    where TUser : IdentityUser<TKey>
    where TRole : IdentityRole<TKey>
    where TKey : IEquatable<TKey>
    where TUserClaim : IdentityUserClaim<TKey>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="IdentityDbContext{TUser, TRole, TKey, TUserClaim, TUserPasswordAuth, TUserRole, TUserLogin, TRoleClaim, TUserToken, TUserPasskey}"/> class.
    /// </summary>
    /// <param name="options">The options to be used by a <see cref="DbContext"/>.</param>
    public IdentityDbContext(DbContextOptions options)
        : base(options)
    ...
    internal override void OnModelCreatingVersion3(ModelBuilder builder)
    {
        ...
        {
            b.HasKey(r => r.Id);
            b.HasIndex(r => r.Name).HasDatabaseName("RoleNameIndex").IsUnique();
